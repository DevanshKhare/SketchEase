  ...
  return (
    <div className="h-screen pt-8 bg-zinc-950 absolute inset-0 -z-10 w-full items-center px-5 py-24 [background:radial-gradient(150%_150%_at_50%_10%,#000_40%,#63e_100%)]">
      ...
      <div className="text-white w-[90%] m-auto h-full flex items-center justify-center flex-col">
        <h1 className="text-[5rem] leading-9 tracking-wide font-medium">
          Unleashing the
        </h1>
        <h1 className="text-[5rem]">
          Magic of <span className="text-[#63e] font-medium">Design</span>
        </h1>
        <p className="text-center text-zinc-600">
          Build Professional Websites Without a Single Line of Code,
          <br />
